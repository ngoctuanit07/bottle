!function (e) {
    ...
    135: function (e, t, n) {
        ...
        var o = function () {
            ...
            var t, o, r;
            return t = e, r = [{
                key: "updateSEOTitle", value: function (e) {
                ...
                key: "updateSEODescription", value: function (e) {
                    e && ($("#seo_description").val() || $(".page-description-seo").text(e))
                }
            },
                {
                    key: "updateSEOKeyword", value: function (e) {
                        e && ($("#seo_keywords").val() || $(".page-keyword-seo").text(e))
                    }
                }], (o = [{
                key: "handleMetaBox", value: function () {
                    $(".page-url-seo p").text(this.$document.find("#sample-permalink a").prop("href")), this.$document.on("click", ".btn-trigger-show-seo-detail", function (e) {
                        ...
                        if ($(e.currentTarget).val()) $(".page-title-seo").text($(e.currentTarget).val()), $(".default-seo-description").addClass("hidden"), $(".existed-seo-meta").removeClass("hidden"); else {
                        ...
                        $(e.currentTarget).val() ? $(".page-description-seo").text($(e.currentTarget).val()) : $(".page-title-seo").text($("textarea[name=description]").val())
                    })
                }
